    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author', to='blogapi.profile')),
                ('tags', models.ManyToManyField(blank=True, to='blogapi.tag')),
            ],
            options={
                'ordering': ('-publish',),
            },
